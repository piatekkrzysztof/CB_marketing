...
class SaveToDb:
    ...
    def saving(self):
        ...
        for x in range(self.db.__len__()):
            ...
            pgsql = f"""INSERT INTO website_question(contents,ans_A,ans_B, ans_C, ans_D,correct, category_id)
...
adding_to_database()
path = r"C:\Users\krzys\Desktop\CB_marketing\data\marketingpyt.csv"